<x-app-layout>
    <div class="max-w-xl mx-auto mt-10 bg-white p-8 rounded-2xl shadow-md">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Upload Gambar Kamar</h2>

        <form action="{{ route('foto.submit') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
